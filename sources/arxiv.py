"""arXiv paper source — fetches and persists papers from the arXiv API."""
...
class ArxivSource(BaseSource):
    """Concrete source that fetches papers from the arXiv API."""
    ...
    def fetch(
        ...
        *,
        ...
        Args:
            ...
            target_date: fetch papers whose arXiv ``published`` date equals
                this value (YYYY-MM-DD); defaults to the most recent weekday.
            max_results: cap the number of results per category; when *None*
                fetch all available (default).

        Returns:
            A mapping from category to the list of paper dictionaries ready
